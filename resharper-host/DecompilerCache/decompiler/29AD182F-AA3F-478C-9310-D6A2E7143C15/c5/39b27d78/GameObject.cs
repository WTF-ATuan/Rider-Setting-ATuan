...
namespace UnityEngine
{
  ...
  public sealed class GameObject : Object
  {
    ...
    public T GetComponentInParent<T>() => (T) this.GetComponentInParent(typeof (T));
    ...
    public void GetComponents<T>(List<T> results) => this.GetComponentsInternal(typeof (T), false, false, true, false, (object) results);
