...
namespace DG.Tweening
{
  ...
  public static class TweenSettingsExtensions
  {
    ...
    {
      if ((object) t == null || !t.active || t.creationLocked)
        return t;
      t.autoKill = true;
      return t;
    }
    ...
    {
      if ((object) t == null || !t.active || (t.isSequenced || (Object) gameObject == (Object) null))
        return t;
      TweenManager.AddTweenLink((Tween) t, new TweenLink(gameObject, LinkBehaviour.KillOnDestroy));
      return t;
    }
    ...
    public static T SetLink<T>(this T t, GameObject gameObject, LinkBehaviour behaviour) where T : Tween
    {
      if ((object) t == null || !t.active || (t.isSequenced || (Object) gameObject == (Object) null))
        return t;
      TweenManager.AddTweenLink((Tween) t, new TweenLink(gameObject, behaviour));
      return t;
    }
    ...
    public static T SetTarget<T>(this T t, object target) where T : Tween
    {
      ...
      if (DOTween.debugStoreTargetId)
      {
        ...
        t.debugTargetId = (Object) component != (Object) null ? component.name : target.ToString();
      }
      t.target = target;
      return t;
    }
    ...
    public static T SetUpdate<T>(this T t, bool isIndependentUpdate) where T : Tween
    {
      if ((object) t == null || !t.active)
        return t;
      TweenManager.SetUpdateType((Tween) t, DOTween.defaultUpdateType, isIndependentUpdate);
      return t;
    }
    ...
    public static T SetUpdate<T>(this T t, UpdateType updateType) where T : Tween
    {
      if ((object) t == null || !t.active)
        return t;
      TweenManager.SetUpdateType((Tween) t, updateType, DOTween.defaultTimeScaleIndependent);
      return t;
    }
    ...
    public static T SetUpdate<T>(this T t, UpdateType updateType, bool isIndependentUpdate) where T : Tween
    {
      if ((object) t == null || !t.active)
        return t;
      TweenManager.SetUpdateType((Tween) t, updateType, isIndependentUpdate);
      return t;
    }
    ...
    public static T SetAs<T>(this T t, Tween asTween) where T : Tween
    {
      ...
      TweenManager.SetUpdateType((Tween) t, asTween.updateType, asTween.isIndependentUpdate);
      t.id = asTween.id;
      ...
      t.delayComplete = (double) t.delay <= 0.0;
    ...
    public static T SetAs<T>(this T t, TweenParams tweenParams) where T : Tween
    {
      if ((object) t == null || !t.active || t.creationLocked)
        return t;
      TweenManager.SetUpdateType((Tween) t, tweenParams.updateType, tweenParams.isIndependentUpdate);
      t.id = tweenParams.id;
    ...
    {
      if (s == null || !s.active || (s.creationLocked || callback == null))
        return s;
    ...
    public static Sequence PrependCallback(this Sequence s, TweenCallback callback)
    {
      if (s == null || !s.active || (s.creationLocked || callback == null))
        return s;
      Sequence.DoInsertCallback(s, callback, 0.0f);
      return s;
    }
    ...
    public static Sequence InsertCallback(
      this Sequence s,
      float atPosition,
    ...
    {
      if ((object) t == null || !t.active || (t.creationLocked || !t.isFromAllowed))
        return t;
      t.isFrom = true;
      t.SetFrom(false);
      return t;
    ...
    public static TweenerCore<T1, T2, TPlugOptions> From<T1, T2, TPlugOptions>(
      this TweenerCore<T1, T2, TPlugOptions> t,
      T2 fromValue,
    ...
    /// <param name="setImmediately">If TRUE sets the target to from value immediately, otherwise waits for the tween to start</param>
    public static TweenerCore<Color, Color, ColorOptions> From(
      this TweenerCore<Color, Color, ColorOptions> t,
      float fromAlphaValue,
      bool setImmediately = true,
      bool isRelative = false)
    {
      if (t == null || !t.active || (t.creationLocked || !t.isFromAllowed))
        return t;
      t.isFrom = true;
      t.SetFrom(new Color(0.0f, 0.0f, 0.0f, fromAlphaValue), setImmediately, isRelative);
      return t;
    }
    ...
    public static TweenerCore<Vector3, Vector3, VectorOptions> From(
      this TweenerCore<Vector3, Vector3, VectorOptions> t,
      float fromValue,
      bool setImmediately = true,
      bool isRelative = false)
    {
    ...
    public static T SetDelay<T>(this T t, float delay) where T : Tween
    {
      ...
      {
        t.delay = delay;
        t.delayComplete = (double) delay <= 0.0;
      }
      return t;
    }
    ...
    {
      if ((object) t == null || !t.active || (t.creationLocked || t.isFrom) || t.isBlendable)
        return t;
      t.isRelative = true;
      return t;
    }
    ...
    public static Tweener SetOptions(
      this TweenerCore<float, float, FloatOptions> t,
      bool snapping)
    {
      if (t == null || !t.active)
        return (Tweener) t;
    ...
    /// <param name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
    public static Tweener SetOptions(
      this TweenerCore<Vector2, Vector2, VectorOptions> t,
      bool snapping)
    {
      if (t == null || !t.active)
        return (Tweener) t;
    ...
    /// <param name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
    public static Tweener SetOptions(
      this TweenerCore<Vector4, Vector4, VectorOptions> t,
      bool snapping)
    {
      if (t == null || !t.active)
        return (Tweener) t;
    ...
    public static Tweener SetOptions(
      this TweenerCore<Quaternion, Vector3, QuaternionOptions> t,
    ...
    /// <param name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
    public static Tweener SetOptions(
      this TweenerCore<Rect, Rect, RectOptions> t,
      bool snapping)
    {
      if (t == null || !t.active)
        return (Tweener) t;
    ...
    public static Tweener SetOptions(
      this TweenerCore<string, string, StringOptions> t,
    ...
    /// <param name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
    public static Tweener SetOptions(
      this TweenerCore<Vector3, Vector3[], Vector3ArrayOptions> t,
      bool snapping)
    {
      if (t == null || !t.active)
        return (Tweener) t;
    ...
    public static TweenerCore<Vector3, Path, PathOptions> SetLookAt(
      ...
      Vector3? up = null)
    {
      return t.SetLookAt(OrientType.LookAtPosition, lookAtPosition, (Transform) null, -1f, forwardDirection, up);
    }
    ...
    {
      return t.SetLookAt(OrientType.LookAtPosition, lookAtPosition, (Transform) null, -1f, stableZRotation: stableZRotation);
    }
    ...
    public static TweenerCore<Vector3, Path, PathOptions> SetLookAt(
      ...
      bool stableZRotation)
    {
      return t.SetLookAt(OrientType.LookAtTransform, Vector3.zero, lookAtTransform, -1f, stableZRotation: stableZRotation);
    }
    ...
    public static TweenerCore<Vector3, Path, PathOptions> SetLookAt(
      ...
      Vector3? up = null)
    {
      return t.SetLookAt(OrientType.ToPath, Vector3.zero, (Transform) null, lookAhead, forwardDirection, up);
    }
    ...
    public static TweenerCore<Vector3, Path, PathOptions> SetLookAt(
      ...
      bool stableZRotation)
    {
      return t.SetLookAt(OrientType.ToPath, Vector3.zero, (Transform) null, lookAhead, stableZRotation: stableZRotation);
    }

    private static TweenerCore<Vector3, Path, PathOptions> SetLookAt(
      this TweenerCore<Vector3, Path, PathOptions> t,
      ...
      bool stableZRotation = false)
    {
      ...
      switch (orientType)
      {
        case OrientType.ToPath:
          if ((double) lookAhead < 9.99999974737875E-05)
            lookAhead = 0.0001f;
    ...
    private static void SetPathForwardDirection(
      this TweenerCore<Vector3, Path, PathOptions> t,
      Vector3? forwardDirection = null,
      Vector3? up = null)
    {
      if (t == null || !t.active)
        return;
      ref PathOptions local = ref t.plugOptions;
      Vector3? nullable;
      int num;
      if (forwardDirection.HasValue)
      {
        nullable = forwardDirection;
        Vector3 zero = Vector3.zero;
        if ((nullable.HasValue ? (nullable.HasValue ? (nullable.GetValueOrDefault() != zero ? 1 : 0) : 0) : 1) != 0)
        {
          num = 1;
          goto label_8;
        }
      ...
      if (up.HasValue)
      {
        nullable = up;
        Vector3 zero = Vector3.zero;
        num = nullable.HasValue ? (nullable.HasValue ? (nullable.GetValueOrDefault() != zero ? 1 : 0) : 0) : 1;
      }
      else
        num = 0;
label_8:
      local.hasCustomForwardDirection = num != 0;
      if (!t.plugOptions.hasCustomForwardDirection)
        return;
      nullable = forwardDirection;
      Vector3 zero1 = Vector3.zero;
      if ((nullable.HasValue ? (nullable.HasValue ? (nullable.GetValueOrDefault() == zero1 ? 1 : 0) : 1) : 0) != 0)
