...
// MVID: BE28439F-7B01-4FC3-8435-D198C0640FF7
// Assembly location: D:\unity\2020.3.10f1\Editor\Data\Managed\UnityEngine\UnityEngine.CoreModule.dll
...
namespace UnityEngine
{
  ...
  public sealed class GameObject : Object
  {
    ...
    [NativeWritableSelf]
    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::GetComponentFastPath", ThrowsException = true)]
    [MethodImpl(MethodImplOptions.InternalCall)]
    internal extern void GetComponentFastPath(System.Type type, IntPtr oneFurtherThanResultValue);

    [FreeFunction(HasExplicitThis = true, Name = "Scripting::GetScriptingWrapperOfComponentOfGameObject")]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    /// </returns>
    [TypeInferenceRule(TypeInferenceRules.TypeReferencedByFirstArgument)]
    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::GetComponentInChildren", ThrowsException = true)]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    public T GetComponentInChildren<T>([DefaultValue("false")] bool includeInactive) => (T) this.GetComponentInChildren(typeof (T), includeInactive);
    ...
    /// </returns>
    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::GetComponentInParent", ThrowsException = true)]
    [TypeInferenceRule(TypeInferenceRules.TypeReferencedByFirstArgument)]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    public T GetComponentInParent<T>([DefaultValue("false")] bool includeInactive) => (T) this.GetComponentInParent(typeof (T), includeInactive);

    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::GetComponentsInternal", ThrowsException = true)]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    /// <param name="type">The type of Component to retrieve.</param>
    /// <param name="includeInactive">Should Components on inactive GameObjects be included in the found set?</param>
    public Component[] GetComponentsInChildren(System.Type type, [DefaultValue("false")] bool includeInactive) => (Component[]) this.GetComponentsInternal(type, false, true, includeInactive, false, (object) null);
    ...
    public Component[] GetComponentsInParent(System.Type type, [DefaultValue("false")] bool includeInactive) => (Component[]) this.GetComponentsInternal(type, false, true, includeInactive, true, (object) null);
    ...
    [TypeInferenceRule(TypeInferenceRules.TypeReferencedByFirstArgument)]
    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::TryGetComponentFromType", ThrowsException = true)]
    [MethodImpl(MethodImplOptions.InternalCall)]
    internal extern Component TryGetComponentInternal(System.Type type);

    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::TryGetComponentFastPath", ThrowsException = true)]
    [NativeWritableSelf]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    [FreeFunction(HasExplicitThis = true, Name = "MonoAddComponent")]
    [MethodImpl(MethodImplOptions.InternalCall)]
    internal extern Component AddComponentInternal(string className);

    [FreeFunction(HasExplicitThis = true, Name = "MonoAddComponentWithType")]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::CompareTag")]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    [FreeFunction(HasExplicitThis = true, Name = "Scripting::SendScriptingMessageUpwards")]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    /// <param name="value">An optional parameter value to pass to the called method.</param>
    /// <param name="options">Should an error be raised if the method doesn't exist on the target object?</param>
    [FreeFunction(HasExplicitThis = true, Name = "Scripting::SendScriptingMessage")]
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    /// <param name="options"></param>
    [FreeFunction(HasExplicitThis = true, Name = "Scripting::BroadcastScriptingMessage")]
    [MethodImpl(MethodImplOptions.InternalCall)]
    public extern void BroadcastMessage(
      string methodName,
      [DefaultValue("null")] object parameter,
      [DefaultValue("SendMessageOptions.RequireReceiver")] SendMessageOptions options);
    ...
    /// </summary>
    public extern ulong sceneCullingMask { [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::GetSceneCullingMask"), MethodImpl(MethodImplOptions.InternalCall)] get; }

    [FreeFunction(HasExplicitThis = true, Name = "GameObjectBindings::CalculateBounds")]
