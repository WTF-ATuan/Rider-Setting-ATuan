...
namespace UnityEngine
{
  ...
  public sealed class Camera : Behaviour
  {
    ...
    public Vector3 transparencySortAxis
    {
      ...
      set => this.set_transparencySortAxis_Injected(ref value);
    }
    ...
    {
      get => this.GetLayerCullDistances();
      set
      {
        if (value.Length != 32)
    ...
    public Matrix4x4 cullingMatrix
    {
      ...
      set => this.set_cullingMatrix_Injected(ref value);
    }
    ...
    public Color backgroundColor
    {
      ...
      set => this.set_backgroundColor_Injected(ref value);
    }
    ...
    public Vector2 sensorSize
    {
      ...
      set => this.set_sensorSize_Injected(ref value);
    }
    ...
    public Vector2 lensShift
    {
      ...
      set => this.set_lensShift_Injected(ref value);
    }
    ...
    {
      Vector2 ret;
      this.GetGateFittedLensShift_Injected(out ret);
      return ret;
    }
    ...
    public Rect rect
    {
      ...
      set => this.set_rect_Injected(ref value);
    }
    ...
    public Rect pixelRect
    {
      ...
      set => this.set_pixelRect_Injected(ref value);
    }
    ...
    private void SetTargetBuffersImpl(RenderBuffer color, RenderBuffer depth) => this.SetTargetBuffersImpl_Injected(ref color, ref depth);
    ...
    public void SetTargetBuffers(RenderBuffer colorBuffer, RenderBuffer depthBuffer) => this.SetTargetBuffersImpl(colorBuffer, depthBuffer);

    [FreeFunction("CameraScripting::SetTargetBuffers", HasExplicitThis = true)]
    private void SetTargetBuffersMRTImpl(RenderBuffer[] color, RenderBuffer depth) => this.SetTargetBuffersMRTImpl_Injected(color, ref depth);
    ...
    /// <param name="colorBuffer">The RenderBuffer(s) to which color information will be rendered.</param>
    /// <param name="depthBuffer">The RenderBuffer to which depth information will be rendered.</param>
    public void SetTargetBuffers(RenderBuffer[] colorBuffer, RenderBuffer depthBuffer) => this.SetTargetBuffersMRTImpl(colorBuffer, depthBuffer);
    ...
    public Matrix4x4 worldToCameraMatrix
    {
      ...
      set => this.set_worldToCameraMatrix_Injected(ref value);
    }
    ...
    public Matrix4x4 projectionMatrix
    {
      ...
      set => this.set_projectionMatrix_Injected(ref value);
    }
    ...
    public Matrix4x4 nonJitteredProjectionMatrix
    {
      ...
      set => this.set_nonJitteredProjectionMatrix_Injected(ref value);
    }
    ...
    public Vector3 WorldToScreenPoint(Vector3 position) => this.WorldToScreenPoint(position, Camera.MonoOrStereoscopicEye.Mono);
    ...
    /// <param name="eye">Optional argument that can be used to specify which eye transform to use. Default is Mono.</param>
    /// <param name="position"></param>
    public Vector3 WorldToViewportPoint(Vector3 position) => this.WorldToViewportPoint(position, Camera.MonoOrStereoscopicEye.Mono);
    ...
    /// </returns>
    public Vector3 ViewportToWorldPoint(Vector3 position) => this.ViewportToWorldPoint(position, Camera.MonoOrStereoscopicEye.Mono);
    ...
    /// </returns>
    public Vector3 ScreenToWorldPoint(Vector3 position) => this.ScreenToWorldPoint(position, Camera.MonoOrStereoscopicEye.Mono);
    ...
    public Ray ViewportPointToRay(Vector3 pos, Camera.MonoOrStereoscopicEye eye) => this.ViewportPointToRay((Vector2) pos, eye);
    ...
    public Ray ViewportPointToRay(Vector3 pos) => this.ViewportPointToRay(pos, Camera.MonoOrStereoscopicEye.Mono);
    ...
    public Ray ScreenPointToRay(Vector3 pos, Camera.MonoOrStereoscopicEye eye) => this.ScreenPointToRay((Vector2) pos, eye);
    ...
    /// <param name="eye">Optional argument that can be used to specify which eye transform to use. Default is Mono.</param>
    /// <param name="pos"></param>
    public Ray ScreenPointToRay(Vector3 pos) => this.ScreenPointToRay(pos, Camera.MonoOrStereoscopicEye.Mono);
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    public static extern float HorizontalToVerticalFieldOfView(
    ...
    /// <param name="aspectRatio">The aspect ratio value used for the conversion</param>
    [MethodImpl(MethodImplOptions.InternalCall)]
    public static extern float VerticalToHorizontalFieldOfView(
    ...
    public Scene scene
    {
      ...
      [FreeFunction("CameraScripting::SetScene", HasExplicitThis = true)] set => this.set_scene_Injected(ref value);
    }
    ...
    public void SetStereoProjectionMatrix(Camera.StereoscopicEye eye, Matrix4x4 matrix) => this.SetStereoProjectionMatrix_Injected(eye, ref matrix);
    ...
    public void SetStereoViewMatrix(Camera.StereoscopicEye eye, Matrix4x4 matrix) => this.SetStereoViewMatrix_Injected(eye, ref matrix);
    ...
    /// </summary>
    public static int allCamerasCount => Camera.GetAllCamerasCount();
    ...
    /// </returns>
    public bool RenderToCubemap(Cubemap cubemap, int faceMask) => this.RenderToCubemapImpl((Texture) cubemap, faceMask);

    public bool RenderToCubemap(Cubemap cubemap) => this.RenderToCubemapImpl((Texture) cubemap, 63);
    ...
    ///   <para>False if rendering fails, else true.</para>
    /// </returns>
    public bool RenderToCubemap(RenderTexture cubemap, int faceMask) => this.RenderToCubemapImpl((Texture) cubemap, faceMask);

    public bool RenderToCubemap(RenderTexture cubemap) => this.RenderToCubemapImpl((Texture) cubemap, 63);
    ...
    public bool TryGetCullingParameters(out ScriptableCullingParameters cullingParameters) => Camera.GetCullingParameters_Internal(this, false, out cullingParameters, sizeof (ScriptableCullingParameters));

    public bool TryGetCullingParameters(
      bool stereoAware,
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    private static extern bool GetCullingParameters_Internal(
      Camera camera,
      bool stereoAware,
      out ScriptableCullingParameters cullingParameters,
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void ResetFieldOfView() => this.fieldOfView = 60f;
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public Matrix4x4[] GetStereoViewMatrices() => new Matrix4x4[2]
    {
    ...
    public Matrix4x4[] GetStereoProjectionMatrices() => new Matrix4x4[2]
    {
