...
namespace UnityEngine
{
  ...
  public sealed class RectTransform : Transform
  {
    ...
    public Vector2 anchorMin
    {
      ...
      set => this.set_anchorMin_Injected(ref value);
    }
    ...
    public Vector2 anchorMax
    {
      ...
      set => this.set_anchorMax_Injected(ref value);
    }
    ...
    public Vector2 anchoredPosition
    {
      ...
      set => this.set_anchoredPosition_Injected(ref value);
    }
    ...
    public Vector2 sizeDelta
    {
      ...
      set => this.set_sizeDelta_Injected(ref value);
    }
    ...
    public Vector2 pivot
    {
      ...
      set => this.set_pivot_Injected(ref value);
    }
    ...
    public void SetInsetAndSizeFromParentEdge(RectTransform.Edge edge, float inset, float size)
    {
      ...
      Vector2 anchoredPosition = this.anchoredPosition;
      anchoredPosition[index] = flag ? (float) (-(double) inset - (double) size * (1.0 - (double) this.pivot[index])) : inset + size * this.pivot[index];
    ...
    public void SetSizeWithCurrentAnchors(RectTransform.Axis axis, float size)
    {
      ...
      Vector2 vector2 = this.GetParentSize();
      double num2 = (double) vector2[index1];
      vector2 = this.anchorMax;
      double num3 = (double) vector2[index1];
      vector2 = this.anchorMin;
      double num4 = (double) vector2[index1];
      double num5 = num3 - num4;
      double num6 = num2 * num5;
      double num7 = num1 - num6;
      local[index2] = (float) num7;
      this.sizeDelta = sizeDelta;
    }
    ...
    {
      RectTransform.ReapplyDrivenProperties drivenProperties = RectTransform.reapplyDrivenProperties;
      if (drivenProperties == null)
        return;
      drivenProperties(driven);
    }
